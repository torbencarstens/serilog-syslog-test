...
namespace Serilog
{
    ...
    public static class SyslogLoggerConfigurationExtensions
    {
        ...
        public static LoggerConfiguration LocalSyslog(this LoggerSinkConfiguration loggerSinkConfig,
            string appName = null, string host = null, Facility facility = Facility.Local0, string outputTemplate = null,
            LogEventLevel restrictedToMinimumLevel = LevelAlias.Minimum)
        {
            if (!RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
                throw new ArgumentException("The local syslog sink is only supported on Linux systems");

            var formatter = GetFormatter(SyslogFormat.Local, appName, host, facility, outputTemplate);
        ...
        public static LoggerConfiguration UdpSyslog(this LoggerSinkConfiguration loggerSinkConfig,
            string host, int port = 514, string appName = null, string hostName = null, SyslogFormat format = SyslogFormat.RFC3164,
            ...
            string messageIdPropertyName = Rfc5424Formatter.DefaultMessageIdPropertyName)
        {
            ...
            var formatter = GetFormatter(format, appName, hostName, facility, outputTemplate, messageIdPropertyName);
        ...
        {
            var formatter = GetFormatter(format, appName, host, facility, outputTemplate, messageIdPropertyName);
        ...
        private static ISyslogFormatter GetFormatter(SyslogFormat format, string appName, string host, Facility facility,
            ...
            string messageIdPropertyName = null)
        {
            ...
            {
                SyslogFormat.RFC3164 => new Rfc3164Formatter(facility, appName, host, templateFormatter),
